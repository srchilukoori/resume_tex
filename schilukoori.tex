...
\Entry 13 years of experience in the data, analytics engineering, and datascience fields in:
...
\Entry \textbf{Programming Languages:} Python, Scala, Rust, SQL, HiveQL
...
{Meta Platforms Inc}
{Meta Platforms Inc}
{PDF:MetaPlatformsInc}
\par Menlo Park, CA

\BigGap
\begingroup
\textbf{Staff Data Engineer}
\hfill
\DatestampYMD{2024}{01}{22} -- Present

\BulletItem Led the design and development of Media Warehouse, etl pipelines, data-quality alerts
\BulletItem Developed scalable ingest processes to add new media channels into the Media Warehouse
\BulletItem Designed the Python module for running Media-Mix model training, predictions \& budget optimizers
\BulletItem Mentored junior engineers on data engineering best practices, design reviews and stakeholder management
\endgroup
